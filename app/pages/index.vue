...
<template>
  <div class="min-h-screen bg-slate-100 text-slate-900 dark:bg-gradient-to-b dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 dark:text-white transition-colors">
    ...
    <!-- Hero Section -->
    <section class="relative pt-28 pb-14 px-4 overflow-hidden">
      <div
      ...
      <div class="container relative mx-auto max-w-5xl text-center">
        <p class="text-emerald-600 dark:text-emerald-400 font-medium mb-2 text-sm uppercase tracking-widest">
          tumeta.app
        </p>
        ...
        <p class="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto mb-6 dark:text-slate-400">
    ...
    <section class="py-12 px-4">
      <div class="container mx-auto max-w-6xl">
        <h2 class="text-2xl md:text-3xl font-bold text-center mb-8 text-slate-900 dark:text-white">
    ...
    <!-- Eventos destacados -->
    <section v-if="events.length > 0" class="py-12 px-4">
      <div class="container mx-auto max-w-6xl">
        <h2 class="text-2xl md:text-3xl font-bold text-center mb-8 text-slate-900 dark:text-white">
          Próximos eventos
        </h2>
    ...
    <section class="py-12 px-4">
      <div class="container mx-auto max-w-4xl">
        <div class="rounded-2xl border border-emerald-200 bg-emerald-50 p-6 md:p-8 text-center dark:border-emerald-500/30 dark:bg-emerald-500/5">
    ...
    <section class="py-14 px-4">
      <div class="container mx-auto max-w-3xl text-center">
        <h2 class="text-2xl md:text-3xl font-bold mb-3 text-slate-900 dark:text-white">
    ...
    <!-- Footer -->
    <footer class="border-t border-slate-200 py-6 px-4 dark:border-white/10">
